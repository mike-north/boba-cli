...
import { Style, resolveColor, width as textWidth, type ColorInput } from "@suds-cli/chapstick";
...
function resolvedColor(color: ColorInput | undefined, fallback: string): string {
...
export class ProgressModel {
  ...
  constructor(options: ProgressOptions = {}, state: ProgressInit = {}) {
    ...
    const start = options.gradientStart ? resolveColor(options.gradientStart) : undefined;
    const end = options.gradientEnd ? resolveColor(options.gradientEnd) : undefined;
