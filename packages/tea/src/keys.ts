...
const sequences: Sequence[] = [
  ...
  ['\u001b[1;2A', { type: KeyType.ShiftUp, runes: '', alt: false, paste: false }],
  ['\u001b[1;2B', { type: KeyType.ShiftDown, runes: '', alt: false, paste: false }],
  ['\u001b[1;2C', { type: KeyType.ShiftRight, runes: '', alt: false, paste: false }],
  ['\u001b[1;2D', { type: KeyType.ShiftLeft, runes: '', alt: false, paste: false }],
  ['\u001b[1;5A', { type: KeyType.CtrlUp, runes: '', alt: false, paste: false }],
  ['\u001b[1;5B', { type: KeyType.CtrlDown, runes: '', alt: false, paste: false }],
  ['\u001b[1;5C', { type: KeyType.CtrlRight, runes: '', alt: false, paste: false }],
  ['\u001b[1;5D', { type: KeyType.CtrlLeft, runes: '', alt: false, paste: false }],
  ['\u001b[1;6A', { type: KeyType.CtrlShiftUp, runes: '', alt: false, paste: false }],
  ['\u001b[1;6B', { type: KeyType.CtrlShiftDown, runes: '', alt: false, paste: false }],
  ['\u001b[1;6C', { type: KeyType.CtrlShiftRight, runes: '', alt: false, paste: false }],
  ['\u001b[1;6D', { type: KeyType.CtrlShiftLeft, runes: '', alt: false, paste: false }],
  ...
  ['\u001b[5;5~', { type: KeyType.CtrlPgUp, runes: '', alt: false, paste: false }],
  ['\u001b[6;5~', { type: KeyType.CtrlPgDown, runes: '', alt: false, paste: false }],
...
export function parseKey(
  ...
  const mapped: KeyType | undefined = Object.prototype.hasOwnProperty.call(controlKeyMap, code)
    ? controlKeyMap[code]
    : undefined;
  if (mapped !== undefined) {
    return { key: { type: mapped, runes: '', alt: false, paste: false }, length: 1 };
  }
  ...
  if (rune === ' ') {
    return { key: { type: KeyType.Space, runes: rune, alt: false, paste: false }, length: runeLength };
  }
